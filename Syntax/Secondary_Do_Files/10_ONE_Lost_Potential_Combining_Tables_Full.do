...
***************************************************
**************Outputting Combined Tables Full *******************
**************************************************
...
putexcel set "$outputs\Tables_Combined_Full.xlsx", sheet(1. LP BAU) replace
...
putexcel set "$outputs\Tables_Combined_Full.xlsx", sheet(2. OS BAU) modify
...
use "$interim/Lost_Potential_Database_With_Indicators_Halving.dta", clear

putexcel set "$outputs\Tables_Combined_Full.xlsx", sheet(3. LP Half) modify

foreach x in 2015	2016	2017	2018	2019	2020	2021	2022	2023	2024	2025	2026	2027	2028	2029	2030 {

rename lost_sum_`x'_f old_lost_sum_`x'_f
rename h_lost_sum_`x'_f lost_sum_`x'_f
rename lost_sum_`x'_m old_lost_sum_`x'_m
rename h_lost_sum_`x'_m lost_sum_`x'_m

rename lostpotential_`x'_f old_lostpotential_`x'_f
rename h_lostpotential_`x'_f lostpotential_`x'_f
rename lostpotential_`x'_m old_lostpotential_`x'_m
rename h_lostpotential_`x'_m lostpotential_`x'_m
...
putexcel set "$outputs\Tables_Combined_Full.xlsx", sheet(4. OS Half) modify


foreach x in 2015	2016	2017	2018	2019	2020	2021	2022	2023	2024	2025	2026	2027	2028	2029	2030 {

rename sum_os_`x'_f old_sum_os_`x'_f
rename h_sum_os_`x'_f sum_os_`x'_f
rename sum_os_`x'_m old_sum_os_`x'_m
rename h_sum_os_`x'_m sum_os_`x'_m

rename oppsecured_`x'_f old_oppsecured_`x'_f
rename h_oppsecured_`x'_f oppsecured_`x'_f
rename oppsecured_`x'_m old_oppsecured_`x'_m
rename h_oppsecured_`x'_m oppsecured_`x'_m
...
use "$interim/Lost_Potential_Database_With_Indicators_Ending.dta", clear

putexcel set "$outputs\Tables_Combined_Full.xlsx", sheet(5. LP End) modify


foreach x in 2015	2016	2017	2018	2019	2020	2021	2022	2023	2024	2025	2026	2027	2028	2029	2030 {

rename lost_sum_`x'_f old_lost_sum_`x'_f
rename e_lost_sum_`x'_f lost_sum_`x'_f
rename lost_sum_`x'_m old_lost_sum_`x'_m
rename e_lost_sum_`x'_m lost_sum_`x'_m

rename lostpotential_`x'_f old_lostpotential_`x'_f
rename e_lostpotential_`x'_f lostpotential_`x'_f
rename lostpotential_`x'_m old_lostpotential_`x'_m
rename e_lostpotential_`x'_m lostpotential_`x'_m
...
putexcel set "$outputs\Tables_Combined_Full.xlsx", sheet(6. OS End) modify


foreach x in 2015	2016	2017	2018	2019	2020	2021	2022	2023	2024	2025	2026	2027	2028	2029	2030 {

rename sum_os_`x'_f old_sum_os_`x'_f
rename e_sum_os_`x'_f sum_os_`x'_f
rename sum_os_`x'_m old_sum_os_`x'_m
rename e_sum_os_`x'_m sum_os_`x'_m

rename oppsecured_`x'_f old_oppsecured_`x'_f
rename e_oppsecured_`x'_f oppsecured_`x'_f
rename oppsecured_`x'_m old_oppsecured_`x'_m
rename e_oppsecured_`x'_m oppsecured_`x'_m
...
putexcel set "$outputs\Tables_Combined_Full.xlsx", sheet(7. LP C19 BAU) modify
...
putexcel set "$outputs\Tables_Combined_Full.xlsx", sheet(8. OS C19 BAU) modify
...
use "$interim/Lost_Potential_Database_With_Indicators_Halving_Covid.dta", clear

putexcel set "$outputs\Tables_Combined_Full.xlsx", sheet(9. LP C19 Half) modify

foreach x in 2015	2016	2017	2018	2019	2020	2021	2022	2023	2024	2025	2026	2027	2028	2029	2030 {

rename lost_sum_`x'_f old_lost_sum_`x'_f
rename h_lost_sum_`x'_f_covid lost_sum_`x'_f
rename lost_sum_`x'_m old_lost_sum_`x'_m
rename h_lost_sum_`x'_m_covid lost_sum_`x'_m

rename lostpotential_`x'_f old_lostpotential_`x'_f
rename h_lostpotential_`x'_f_covid lostpotential_`x'_f
rename lostpotential_`x'_m old_lostpotential_`x'_m
rename h_lostpotential_`x'_m_covid lostpotential_`x'_m
...
putexcel set "$outputs\Tables_Combined_Full.xlsx", sheet(10. OS C19 Half) modify

foreach x in 2015	2016	2017	2018	2019	2020	2021	2022	2023	2024	2025	2026	2027	2028	2029	2030 {

rename sum_os_`x'_f old_sum_os_`x'_f
rename h_sum_os_`x'_f_covid sum_os_`x'_f
rename sum_os_`x'_m old_sum_os_`x'_m
rename h_sum_os_`x'_m_covid sum_os_`x'_m

rename oppsecured_`x'_f old_oppsecured_`x'_f
rename h_oppsecured_`x'_f_covid oppsecured_`x'_f
rename oppsecured_`x'_m old_oppsecured_`x'_m
rename h_oppsecured_`x'_m_covid oppsecured_`x'_m
...
use "$interim/Lost_Potential_Database_With_Indicators_Ending_Covid.dta", clear

putexcel set "$outputs\Tables_Combined_Full.xlsx", sheet(11. LP C19 End) modify

foreach x in 2015	2016	2017	2018	2019	2020	2021	2022	2023	2024	2025	2026	2027	2028	2029	2030 {

rename lost_sum_`x'_f old_lost_sum_`x'_f
rename e_lost_sum_`x'_f_covid lost_sum_`x'_f
rename lost_sum_`x'_m old_lost_sum_`x'_m
rename e_lost_sum_`x'_m_covid lost_sum_`x'_m

rename lostpotential_`x'_f old_lostpotential_`x'_f
rename e_lostpotential_`x'_f_covid lostpotential_`x'_f
rename lostpotential_`x'_m old_lostpotential_`x'_m
rename e_lostpotential_`x'_m_covid lostpotential_`x'_m
...
putexcel set "$outputs\Tables_Combined_Full.xlsx", sheet(12. OS C19 End) modify

foreach x in 2015	2016	2017	2018	2019	2020	2021	2022	2023	2024	2025	2026	2027	2028	2029	2030 {

rename sum_os_`x'_f old_sum_os_`x'_f
rename e_sum_os_`x'_f_covid sum_os_`x'_f
rename sum_os_`x'_m old_sum_os_`x'_m
rename e_sum_os_`x'_m_covid sum_os_`x'_m

rename oppsecured_`x'_f old_oppsecured_`x'_f
rename e_oppsecured_`x'_f_covid oppsecured_`x'_f
rename oppsecured_`x'_m old_oppsecured_`x'_m
rename e_oppsecured_`x'_m_covid oppsecured_`x'_m
...
putexcel set "$outputs\Tables_Combined_Full.xlsx", sheet(13. Children Turning 10) modify

putexcel A5 = ("Female")
putexcel A6 = ("Male")


sum sum_t_ten_daily_2015_f
return list
putexcel B4 = (2015)
putexcel B5 = (`r(mean)')

sum sum_t_ten_daily_2016_f
return list
putexcel C4 = (2016)
putexcel C5 = (`r(mean)')

sum sum_t_ten_daily_2017_f
return list
putexcel D4 = (2017)
putexcel D5 = (`r(mean)')

sum sum_t_ten_daily_2018_f
return list
putexcel E4 = (2018)
putexcel E5 = (`r(mean)')

sum sum_t_ten_daily_2019_f
return list
putexcel F4 = (2019)
putexcel F5 = (`r(mean)')

sum sum_t_ten_daily_2020_f
return list
putexcel G4 = (2020)
putexcel G5 = (`r(mean)')

sum sum_t_ten_daily_2021_f
return list
putexcel H4 = (2021)
putexcel H5 = (`r(mean)')

sum sum_t_ten_daily_2022_f
return list
putexcel I4 = (2022)
putexcel I5 = (`r(mean)')

sum sum_t_ten_daily_2023_f
return list
putexcel J4 = (2023)
putexcel J5 = (`r(mean)')

sum sum_t_ten_daily_2024_f
return list
putexcel K4 = (2024)
putexcel K5 = (`r(mean)')

sum sum_t_ten_daily_2025_f
return list
putexcel L4 = (2025)
putexcel L5 = (`r(mean)')

sum sum_t_ten_daily_2026_f
return list
putexcel M4 = (2026)
putexcel M5 = (`r(mean)')

sum sum_t_ten_daily_2027_f
return list
putexcel N4 = (2027)
putexcel N5 = (`r(mean)')

sum sum_t_ten_daily_2028_f
return list
putexcel O4 = (2028)
putexcel O5 = (`r(mean)')

sum sum_t_ten_daily_2029_f
return list
putexcel P4 = (2029)
putexcel P5 = (`r(mean)')

sum sum_t_ten_daily_2030_f
return list
putexcel Q4 = (2030)
putexcel Q5 = (`r(mean)')
...
sum sum_t_ten_daily_2015_m
return list
putexcel B6 = (`r(mean)')

sum sum_t_ten_daily_2016_m
return list
putexcel C6 = (`r(mean)')


sum sum_t_ten_daily_2017_m
return list
putexcel D6  = (`r(mean)')


sum sum_t_ten_daily_2018_m
return list
putexcel E6 = (`r(mean)')


sum sum_t_ten_daily_2019_m
return list
putexcel F6 = (`r(mean)')

sum sum_t_ten_daily_2020_m
return list
putexcel G6 = (`r(mean)')

sum sum_t_ten_daily_2021_m
return list
putexcel H6 = (`r(mean)')

sum sum_t_ten_daily_2022_m
return list
putexcel I6 = (`r(mean)')

sum sum_t_ten_daily_2023_m
return list
putexcel J6 = (`r(mean)')

sum sum_t_ten_daily_2024_m
return list
putexcel K6 = (`r(mean)')

sum sum_t_ten_daily_2025_m
return list
putexcel L6 = (`r(mean)')

sum sum_t_ten_daily_2026_m
return list
putexcel M6 = (`r(mean)')


sum sum_t_ten_daily_2027_m
return list
putexcel N6 = (`r(mean)')

sum sum_t_ten_daily_2028_m
return list
putexcel O6 = (`r(mean)')

sum sum_t_ten_daily_2029_m
return list
putexcel P6 = (`r(mean)')

sum sum_t_ten_daily_2030_m
return list
putexcel Q6 = (`r(mean)')
...
egen LIC_`x'_f=total(t_ten_daily_`x'_f) if income_group==1
egen LIC_`x'_m=total(t_ten_daily_`x'_m) if income_group==1
egen LMIC_`x'_f=total(t_ten_daily_`x'_f) if income_group==2
egen LMIC_`x'_m=total(t_ten_daily_`x'_m) if income_group==2
egen UMIC_`x'_f=total(t_ten_daily_`x'_f) if income_group==3
egen UMIC_`x'_m=total(t_ten_daily_`x'_m) if income_group==3
egen HIC_`x'_f=total(t_ten_daily_`x'_f) if income_group==4
egen HIC_`x'_m=total(t_ten_daily_`x'_m) if income_group==4
...
egen EAP_`x'_f=total(t_ten_daily_`x'_f) if world_region==1
egen EAP_`x'_m=total(t_ten_daily_`x'_m) if world_region==1
egen ECA_`x'_f=total(t_ten_daily_`x'_f) if world_region==2
egen ECA_`x'_m=total(t_ten_daily_`x'_m) if world_region==2
egen LAC_`x'_f=total(t_ten_daily_`x'_f) if world_region==3
egen LAC_`x'_m=total(t_ten_daily_`x'_m) if world_region==3
egen MENA_`x'_f=total(t_ten_daily_`x'_f) if world_region==4
egen MENA_`x'_m=total(t_ten_daily_`x'_m) if world_region==4
egen NA_`x'_f=total(t_ten_daily_`x'_f) if world_region==5
egen NA_`x'_m=total(t_ten_daily_`x'_m) if world_region==5
egen SA_`x'_f=total(t_ten_daily_`x'_f) if world_region==6
egen SA_`x'_m=total(t_ten_daily_`x'_m) if world_region==6
egen SSA_`x'_f=total(t_ten_daily_`x'_f) if world_region==7
egen SSA_`x'_m=total(t_ten_daily_`x'_m) if world_region==7
...
egen un_EAP_`x'_f=total(t_ten_daily_`x'_f) if un_region==1
egen un_EAP_`x'_m=total(t_ten_daily_`x'_m) if un_region==1
egen un_EECA_`x'_f=total(t_ten_daily_`x'_f) if un_region==2
egen un_EECA_`x'_m=total(t_ten_daily_`x'_m) if un_region==2
egen un_WE_`x'_f=total(t_ten_daily_`x'_f) if un_region==3
egen un_WE_`x'_m=total(t_ten_daily_`x'_m) if un_region==3
egen un_LAC_`x'_f=total(t_ten_daily_`x'_f) if un_region==4
egen un_LAC_`x'_m=total(t_ten_daily_`x'_m) if un_region==4
egen un_MENA_`x'_f=total(t_ten_daily_`x'_f) if un_region==5
egen un_MENA_`x'_m=total(t_ten_daily_`x'_m) if un_region==5
egen un_NA_`x'_f=total(t_ten_daily_`x'_f) if un_region==6
egen un_NA_`x'_m=total(t_ten_daily_`x'_m) if un_region==6
egen un_SA_`x'_f=total(t_ten_daily_`x'_f) if un_region==7
egen un_SA_`x'_m=total(t_ten_daily_`x'_m) if un_region==7
egen un_ESA_`x'_f=total(t_ten_daily_`x'_f) if un_region==8
egen un_ESA_`x'_m=total(t_ten_daily_`x'_m) if un_region==8
egen un_WCA_`x'_f=total(t_ten_daily_`x'_f) if un_region==9
egen un_WCA_`x'_m=total(t_ten_daily_`x'_m) if un_region==9
...
egen non_fragile_`x'_f=total(t_ten_daily_`x'_f) if oecd_fragile==0
egen non_fragile_`x'_m=total(t_ten_daily_`x'_m) if oecd_fragile==0
egen fragile_`x'_f=total(t_ten_daily_`x'_f) if oecd_fragile==1
egen fragile_`x'_m=total(t_ten_daily_`x'_m) if oecd_fragile==1
}
*
